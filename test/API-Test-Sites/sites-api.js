...
require('./Custom-Site/CRUD-Tests');
require('./Custom-Site/ApiActions/APIActionsTests');
require('./From_Template/accessTokenSecurityTests');
require('./Custom-Site/dataValidationTests');
...
require('./Custom-Site/searchFilterTests');